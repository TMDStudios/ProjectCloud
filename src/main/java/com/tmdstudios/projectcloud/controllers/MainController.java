...
public class MainController {
	...
	@RequestMapping(value="/projects/new", method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value="/my-projects", method = { RequestMethod.GET, RequestMethod.POST })
